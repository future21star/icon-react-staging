		...
		return (
			<div>
				{is_featured ?
					...
					:
					<div
						className={isVideo ? `col-sm-6 col-xs-12 feed-post feed-post-${type}` : `col-sm-6 col-xs-12 display-table-mobile feed-post feed-post-${type}`}>
						<div
							className={isVideo ? 'col-xs-6 col-sm-12 fluid-width-container' : (isVideoInner ? 'col-xs-12' : 'table-cell-mobile col-sm-12 col-xs-4 feed-post-image')}>
